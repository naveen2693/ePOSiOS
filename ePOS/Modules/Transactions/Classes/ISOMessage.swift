...
class ISOMessage{
    ...
    func vFnSetIsoPacketDate() {
        ...
        let strISOPacketDate = String(bytes: m_chArrISOPacketDate, encoding: String.Encoding.utf8)?.trimmingCharacters(in: .whitespacesAndNewlines)
    ...
    func addEncryptedLLLCHARData(bitno: Int, data1: [Byte], length: Int) -> Bool {
        do {
            ...
            debugPrint("EncryptedData \(encData)")
            debugPrint("Enc Hex String \(TransactionUtils.byteArray2HexString(arr: encData))")
